...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-foreground">
      {/* Hero Section */}
      <section className="relative pt-16 md:pt-28 pb-6 md:pb-12 px-6 text-center">
      ...
      <section className="px-4 md:px-6 max-w-5xl mx-auto relative z-10 mb-10 md:mb-20 -mt-6 md:mt-0">
