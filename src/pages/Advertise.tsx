import { Sparkles, Zap, Search, ArrowRight, CheckCircle2, Heart } from "lucide-react";
import { Button } from "@/components/ui/button";

const Advertise = () => {
  return (
    <div className="min-h-screen bg-[#050505] text-foreground pt-32 pb-20 px-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-20">
        ...
        <div className="group relative bg-[#0F0F0F] border border-white/5 rounded-[2rem] p-8 transition-all hover:border-primary/40 hover:shadow-[0_0_40px_-10px_rgba(var(--primary),0.2)]">
          ...
          <Button className="w-full h-12 rounded-xl bg-white/5 hover:bg-primary text-white border border-white/10 font-bold" asChild>
            <a href="/contact">Book This Spot</a>
          </Button>
        </div>
        ...
        <div className="group relative bg-[#0F0F0F] border border-primary/40 rounded-[2rem] p-8 shadow-[0_0_40px_-10px_rgba(var(--primary),0.3)] transition-all">
          ...
          <Button className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-black shadow-lg shadow-primary/25" asChild>
            <a href="/contact">Book This Spot</a>
          </Button>
        </div>
      </div>
