  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 999, background: "#F9FAFB", overflowY: "auto", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
      <div style={{ position: "fixed", top: 0, left: 0, width: "100%", height: "4px", background: "#e5e7eb", zIndex: 1000 }}>
        <div style={{ height: "100%", background: "#8b5cf6", width: `${(step / 3) * 100}%`, transition: "width 0.5s ease" }} />
      </div>
      <div style={{ width: "100%", maxWidth: "480px" }}>
        {step === 0 && (
          <div>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.5rem" }}>
              <div style={{ padding: "1rem", background: "rgba(139, 92, 246, 0.1)", borderRadius: "50%", color: "#8b5cf6" }}><Target size={32} /></div>
            </div>
        ...
        {step === 1 && (
          <div>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.5rem" }}>
              <div style={{ padding: "1rem", background: "rgba(139, 92, 246, 0.1)", borderRadius: "50%", color: "#8b5cf6" }}><User size={32} /></div>
            </div>
        ...
        {step === 2 && (
          <div>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.5rem" }}>
              <div style={{ padding: "1rem", background: "rgba(139, 92, 246, 0.1)", borderRadius: "50%", color: "#8b5cf6" }}><Lightbulb size={32} /></div>
            </div>
        ...
        {step === 3 && (
          <div style={{ background: "white", padding: "2.5rem", borderRadius: "1.5rem", boxShadow: "0 25px 50px rgba(0,0,0,0.12)", border: "1px solid #e0e7ff", textAlign: "center" }}>
            <div style={{ display: "inline-flex", padding: "1rem", borderRadius: "50%", background: "rgba(139, 92, 246, 0.1)", color: "#8b5cf6", marginBottom: "1.5rem" }}><Sparkles size={32} /></div>
            <h2 style={{ fontSize: "1.75rem", fontWeight: 900, color: "#111", marginBottom: "0.75rem" }}>Match Found! 🎯</h2>
            <p style={{ fontSize: "1rem", fontWeight: 700, color: "#8b5cf6", marginBottom: "1rem" }}>We found the best AI tools for your exact problem.</p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              ...
              <button onClick={handleFinish} style={{ padding: "1rem", background: "#8b5cf6", color: "white", fontWeight: 900, fontSize: "1rem", borderRadius: "0.75rem", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", fontFamily: "inherit" }}>
  ...
  return (
    ...
    <div style={{ display: "grid", gap: "1.25rem", gridTemplateColumns: "repeat(auto-fill, minmax(min(100%, 280px), 1fr))" }}>
      {tools.map((tool) => {
        ...
        return (
          <div key={tool.id}
            style={{ position: "relative", background: "#161616", border: `1px solid ${isHighlighted ? "rgba(139, 92, 246, 0.4)" : "rgba(255,255,255,0.06)"}`, borderRadius: "1.25rem", padding: "1.25rem", transition: "transform 0.25s, border-color 0.25s", display: "flex", flexDirection: "column", overflow: "hidden" }}
            onMouseOver={e => { e.currentTarget.style.transform = "translateY(-3px)"; e.currentTarget.style.borderColor = "rgba(139, 92, 246, 0.4)"; }}
            onMouseOut={e => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.borderColor = isHighlighted ? "rgba(139, 92, 246, 0.4)" : "rgba(255,255,255,0.06)"; }}>
            <div style={{ position: "absolute", top: "-50px", right: "-50px", width: "140px", height: "140px", borderRadius: "50%", background: `rgba(139, 92, 246, ${isHighlighted ? "0.15" : "0.03"})`, filter: "blur(35px)", pointerEvents: "none" }} />
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.875rem", position: "relative", zIndex: 1 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "0.375rem" }}>
                <button onClick={() => onToggleSave(String(tool.id))} style={{ padding: "0.4rem", borderRadius: "50%", border: `1px solid ${isSaved ? "rgba(139, 92, 246, 0.5)" : "rgba(255,255,255,0.1)"}`, background: isSaved ? "rgba(139, 92, 246, 0.15)" : "rgba(255,255,255,0.04)", color: isSaved ? "#8b5cf6" : "#6b7280", cursor: "pointer" }}>
            ...
            <span style={{ fontSize: "9px", fontWeight: 800, color: "#71717a", textTransform: "uppercase", letterSpacing: "0.08em", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", padding: "2px 7px", borderRadius: "4px", display: "inline-block", marginBottom: "0.5rem", position: "relative", zIndex: 1, alignSelf: "flex-start" }}>{tool.category}</span>
      ...
      <div style={{ minHeight: "100vh", background: "#0d0d0d", color: "white" }}>
        ...
        <section style={{ position: "relative", paddingTop: "5.5rem", paddingBottom: "1.5rem", textAlign: "center", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 1, maxWidth: "820px", margin: "0 auto", padding: "0 1.5rem" }}>
            ...
            <p style={{ color: "#6b7280", fontSize: "clamp(0.9rem, 2vw, 1.1rem)", maxWidth: "540px", margin: "0 auto 2.5rem", lineHeight: 1.65 }}>
                ...
                <div style={{ position: "absolute", top: "calc(100% + 8px)", right: 0, width: "150px", background: "#111", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "1rem", overflow: "hidden", zIndex: 100, boxShadow: "0 20px 60px rgba(0,0,0,0.8)" }}>
                  {["All", "Free", "Freemium", "Premium"].map((price) => (
                    <button key={price} onClick={() => { setPricingFilter(price); setIsPricingOpen(false); }}
                      style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0.825rem 1rem", fontSize: "0.875rem", fontWeight: 700, background: pricingFilter === price ? "rgba(139, 92, 246, 0.1)" : "transparent", color: pricingFilter === price ? "#8b5cf6" : "#9ca3af", border: "none", borderBottom: "1px solid rgba(255,255,255,0.05)", cursor: "pointer", fontFamily: "inherit" }}>
            ...
            {categories.map((cat) => {
              ...
              return (
                <button key={cat} onClick={() => setActiveCategory(cat === "All" ? null : cat)}
                  style={{ flexShrink: 0, padding: "0.4rem 0.9rem", borderRadius: "9999px", fontSize: "0.78rem", fontWeight: 700, whiteSpace: "nowrap", cursor: "pointer", fontFamily: "inherit", background: isActive ? "#8b5cf6" : "#1a1a1a", color: isActive ? "white" : "#6b7280", border: `1px solid ${isActive ? "#8b5cf6" : "rgba(255,255,255,0.08)"}`, transition: "all 0.2s" }}>
                  {cat}
                </button>
              );
            })}
        ...
        <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 1rem 5rem" }}>
          {isLoading ? (
            <div style={{ textAlign: "center", padding: "5rem 0", color: "#8b5cf6", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "0.875rem" }}>Syncing Database...</div>
          ) : (
            <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
              {activeTab === "all" && featured.length > 0 && !search && !quizFilterTag && (
                <section>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.25rem" }}>
                    <div style={{ width: "3px", height: "1.75rem", background: "#8b5cf6", borderRadius: "9999px" }} />
              ...
              {visibleRest.length > 0 ? (
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.25rem", flexWrap: "wrap", gap: "0.75rem" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                      ...
                      <h2 style={{ fontSize: "1.4rem", fontWeight: 700, color: "white", letterSpacing: "-0.02em" }}>
                        {quizFilterTag ? "Your AI Stack" : activeTab === "saved" ? "Your Bookmarks" : activeTab === "free" ? "Free Tools" : search ? "Search Results" : "Explore Collection"}
                      </h2>
                    </div>
                    {quizFilterTag && (
                ...
                <div style={{ textAlign: "center", padding: "4rem 1rem", border: "1px dashed rgba(255,255,255,0.1)", borderRadius: "1.5rem", background: "rgba(255,255,255,0.02)" }}>
                  ...
                  <button onClick={clearQuizFilter} style={{ padding: "0.7rem 1.5rem", background: "#8b5cf6", color: "white", fontWeight: 700, borderRadius: "0.75rem", border: "none", cursor: "pointer", fontFamily: "inherit" }}>View All Tools</button>
                </div>
              )}
              {rest.length > displayLimit && (
                <div style={{ textAlign: "center" }}>
                  <button onClick={() => setDisplayLimit(p => p + 12)}
                    ...
                    onMouseOver={e => { e.currentTarget.style.background = "rgba(139, 92, 246, 0.12)"; e.currentTarget.style.color = "white"; }}
